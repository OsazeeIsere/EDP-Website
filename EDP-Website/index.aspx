                      ...
                      <div class="appointment-area">
                        <form class="appointment-form" id ="fmmodal">
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <label class="control-label">Area Of Practice <span class="required">*</span>
                                    ...
                                    <asp:DropDownList class="wp-form-control wpcf7-select" ID="ddlareaofpractice" runat="server">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <label class="control-label">Local Government Area <span class="required">*</span>
                              </label>
